...
import AlertCompon from '../components/Alert'
		...
		emailjs
			.send(
				...
				import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
				{
					...
					to_email: 'azizbekmamatqulov8001@gmail.com',
			...
			.catch(error => {
				...
				showAlert({ text: 'Message not sent', type: 'danger', show: true })
			})
	}
